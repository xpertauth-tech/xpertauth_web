const ca = {
  ...
  socios: {
    ...
    planes: [
    {
      ...
      items: [
        "100 crèdits en registrar-te",
        "~20 consultes LEX o ~50 consultes NOVA·ALMA",
        "Blog i recursos públics",
        "Webinars oberts",
      ],
      cta: "Contactar amb José Luis",
    },
    {
      id: "individual",
      nombre: "Professional & PIMEs",
      desc: "Per a professionals i petites empreses que volen respostes reals.",
      items: [
        "1.000 crèdits/mes",
        "~200 consultes LEX o ~500 consultes NOVA·ALMA",
        "2h/any de consultoria amb José Luis",
        "Comunitat privada de socis",
    ...
    },
    {
      id: "corporativo",
      nombre: "Gran Empresa",
      desc: "Per a grans corporacions que necessiten suport continu.",
      items: [
        "Crèdits il·limitats",
