const fr = {
  ...
  socios: {
    ...
    planes: [
    {
      id: "gratuito",
      nombre: "Explorateur",
      desc: "Découvrez XpertAuth sans aucun engagement.",
      items: [
        "100 crédits à l'inscription",
        "~20 requêtes LEX ou ~50 requêtes NOVA·ALMA",
        "Blog et ressources publiques",
        "Webinaires ouverts",
      ],
      cta: "Contacter José Luis",
    },
    {
      id: "individual",
      nombre: "Professionnel & PME",
      desc: "Pour les professionnels et petites entreprises qui veulent de vraies réponses.",
      items: [
        "1 000 crédits/mois",
        "~200 requêtes LEX ou ~500 requêtes NOVA·ALMA",
        "2h/an de conseil avec José Luis",
    ...
    {
      id: "corporativo",
      nombre: "Grande Entreprise",
      desc: "Pour les grandes entreprises nécessitant un support continu.",
      items: [
        "Crédits illimités",
